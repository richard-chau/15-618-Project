...
conf.set("spark.driver.memory", '5G')#"2G")
conf.set("spark.executor.cores", "2")
conf.set("spark.serializer", "org.apache.spark.serializer.KryoSerializer")

num_workers = 2#8#16#28#24
conf.set("spark.executor.cores", 2) #str(num_workers))
...
if dataset_type == '100k':
    ...
    inputV_filepath = "train_shuffle.dat"
    test_inputV_filepath = "test_shuffle.dat"
